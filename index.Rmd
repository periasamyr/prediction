...
```{r ldamodel, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r nbmodel, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r rfmodel, message=FALSE, warning=FALSE, cache=TRUE}
...
We notice that of all the models Random Forest was best performing with accuracy of about 98%.
